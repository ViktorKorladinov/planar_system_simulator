                ...
                <div
                    ...
                    <div className="flex items-center space-x-4 w-1/3 justify-end">
                        ...
                        <button onClick={handleCreateBatchSoftMatrix}
                                disabled={isGlobalSubmitting || createMatrixMutation.isPending || !!rateLimitRemaining}
                            ...
                            {rateLimitRemaining ? `Available in ${rateLimitRemaining}` : isGlobalSubmitting || createMatrixMutation.isPending ? 'Processing...' : 'Create Batch'}
                        </button>
                    </div>
                </div>
